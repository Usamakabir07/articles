...
//
//     final popularArticleModel = popularArticleModelFromJson(jsonString);

import 'dart:convert';

PopularArticleModel popularArticleModelFromJson(String str) =>
    PopularArticleModel.fromJson(json.decode(str));

String popularArticleModelToJson(PopularArticleModel data) =>
...
class PopularArticleModel {
  ...
  factory PopularArticleModel.fromJson(Map<String, dynamic> json) =>
      PopularArticleModel(
        status: json["status"],
...
class MediaMetadatum {
  ...
  factory MediaMetadatum.fromJson(Map<String, dynamic> json) => MediaMetadatum(
        url: json["url"] ?? "https://demofree.sirv.com/nope-not-here.jpg",
